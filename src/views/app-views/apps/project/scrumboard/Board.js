...
import { Menu, Form, Input, Modal, Button } from 'antd'
...
const Board = ({ board_id,title, contents, index, isScrollable, isCombineEnabled, useClone }) => {
	...
	const onFinish = newTitle => {
		if(newTitle) {
			...
			updateColumns(newColumns,board_id)
