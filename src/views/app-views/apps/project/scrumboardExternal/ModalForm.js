...
const UpdateCardForm = ({onSubmit, cardData, listId, board_id,user}) => {
...
const ModalForm = ({ visible, modalMode, cardData, listId, board_id , onClose, onModalSubmit,addNotification,adminUsersNoti,user }) => {
	...
	const submit = (values, mode) => {
		...
		if (values && adminUsersNoti && adminUsersNoti.length > 0) {//noti burda  
			let body = {
