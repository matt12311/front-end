              ...
              <Row key={field.key} gutter={16}>
                <Col sm={24} md={7}>
                  <Form.Item
                    ...
                    rules={[
                      { required: false, message: "Please enter variant name" },
                    ]}
                    className="w-100"
                  >
                ...
                <Col sm={24} md={7}>
                  <Form.Item
                    ...
                    rules={[
                      { required: false, message: "Please enter variant price" },
                    ]}
                    className="w-100"
                  >
                    <InputNumber
                ...
                <Col sm={24} md={7}>
                  <Form.Item
                    ...
                    name={[field.name, "stockKeepingUnit"]}
                    fieldKey={[field.fieldKey, "stockKeepingUnit"]}
                    rules={[
                      { required: false, message: "Please enter variant SKU" },
                    ]}
                    className="w-100"
                  >
                    <InputNumber className="w-100" disabled={!(!props.isAdmin || !props.isWH)} />
                  </Form.Item>
                </Col>
                <Col sm={24} md={2}>
                  <MinusCircleOutlined
